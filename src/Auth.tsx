...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-100 via-white to-purple-100 dark:from-slate-950 dark:via-slate-900 dark:to-primary-950 flex flex-col items-center justify-center p-4 transition-colors duration-500">
      <div className="w-full max-w-full bg-white/80 dark:bg-slate-800/80 backdrop-blur-2xl rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.4)] border border-white/50 dark:border-slate-700/50 p-8">
